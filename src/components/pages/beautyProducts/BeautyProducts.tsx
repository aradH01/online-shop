...
import SmailProCard from "@/components/molecules/productCards/SmailProCard";
...
export default function BeautyProducts(){
    ...
    return(
        <div className="">
            ...
            <div className="grid gap-x-4 gap-y-8 grid-cols-1 md:grid-cols-2 lapmidpad:grid-cols-3 mt-4">
                <SmailProCard/>
                <SmailProCard/>
                <SmailProCard/>
                <SmailProCard/>
